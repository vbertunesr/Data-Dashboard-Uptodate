...
function totalStudents() {
  ...
  function infoAlunas() {
    ...
    var medioSpeciNps = document.getElementById("medioSpeciNps");
    ...
    for (var s = 0; s < students.length; s++) {
      ...
      var alunasSprints = aluna.sprints;

      for (var t = 0; t < alunasSprints.length; t++) {
    ...
    var hsePoints = document.getElementById('hsePoints');
    ...
    for (var s = 0; s < students.length; s++) {
      var aluna = students[s];
      var alunaSprints = aluna.sprints;
    ...
    var finalTech = document.getElementById("techPoints");
    finalTech.innerHTML = '<span class="sprint">SPRINT 1 = </span>' + techPointsSprint[0] + '<br>' + '<span class="sprint">SPRINT 2 = </span>' + techPointsSprint[1] + '<br>' + '<span class="sprint">SPRINT 3 = </span>' + techPointsSprint[2] + '<br>' + '<span class="sprint">SPRINT 4 = </span>' + techPointsSprint[3] + '<br>' + '<span> Estudantes que excederam pontos Tech.</span><div id="porcentagemTech"></div><div id="techData"></div>';
  
    var porcentagemTech = document.getElementById("porcentagemTech");
    porcentagemTech.innerHTML = '<span class="sprint">SPRINT 1 = </span>' + parseInt(techPointsSprint[0] * 100 / students.length) + '%' + '<br>' + '<span class="sprint">SPRINT 2 = </span>' + parseInt(techPointsSprint[1] * 100 / students.length) + '%' + '<br>' + '<span class="sprint">SPRINT 3 = </span>' + parseInt(techPointsSprint[2] * 100 / students.length) + '%' + '<br>' + '<span class="sprint">SPRINT 4 = </span>' + parseInt(techPointsSprint[3] * 100 / students.length) + '%' + '<br>' + '<span> % DE ESTUDANTES</span>';
    ...
    satisfied.setAttribute('class', 'box');
  ...
  for (ratingsSprint of ratings) {
    sumMentors += ratingsSprint.teacher;
    sumJedi += ratingsSprint.jedi;
  }

  var mentors = document.getElementById('mentors');
  var finalMentors = sumMentors / ratings.length;
  ...
  pontosMentores.innerHTML = finalMentors.toFixed(1) + '<br>' + '<span>PONTUAÇÃO MÁXIMA: 5.0</span>';

  /* Pontuação média dos mestres Jedi */
   var jedi = document.getElementById('jedi');
  var finalJedi = sumJedi / ratings.length;
  jedi.setAttribute('class', 'box');
  var jediData = document.getElementById('jediData');
  jediData.innerHTML = "PONTUAÇÃO MÉDIA DE JEDI'S" + '<hr class="hr-data-title"></hr>';
